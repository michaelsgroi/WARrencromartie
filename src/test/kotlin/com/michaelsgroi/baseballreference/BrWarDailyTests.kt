...
class BrWarDailyTests {
    ...
    fun testTopCareerWarsPitching() {
        val testee = BrWarDailyLines(BrWarDaily.WAR_DAILY_PITCH_FILE, BrWarDaily.SeasonType.PITCHING)
        val playersByWarDescending = testee.getCareers().sortedByDescending { it.pitchingWar() }
        val topPlayersByWar =
            playersByWarDescending
                .take(5)
    ...
    fun testTopCareerWarsBatting() {
        val testee = BrWarDailyLines(BrWarDaily.WAR_DAILY_BAT_FILE, BrWarDaily.SeasonType.BATTING)
